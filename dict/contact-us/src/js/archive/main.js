...
var constraints = {
    ...
    "phone-number": {
        ...
        // },
        // format: {
        //     // We don't allow anything other than 0-9 ()-
        //     pattern: "[0-9 ()-]+",
        //     // but we don't care if the username is uppercase or lowercase
        //     flags: "g",
...
//     var new_pattern = phone_number.placeholder.replace(new RegExp("[-]", "g"), "[?-]?[? ]?");
//     new_pattern = new_pattern.replace(new RegExp("[ ]", "g"), "[?-]?[? ]?");
//     new_pattern = new_pattern.replace(new RegExp("[0-9]", "g"), "[0-9]");
//     new_pattern = new_pattern.replace(new RegExp("[(]", "g"), "[?(]?");
//     new_pattern = new_pattern.replace(new RegExp("[)]", "g"), "[?)]?");
//     new_pattern = "[?+]?" + new_pattern;
//     constraints['phone-number']['format']['pattern'] = new_pattern;
//     return new_pattern;
// }
...
// phone_number.onmousedown = event_error;

phone_number.oninput = (event) => {
    // update_regex();
